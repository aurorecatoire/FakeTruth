...
import "./ImageOrVideoScreen.css";

const ImageOrVideoScreen = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get("http://localhost:3000/ImageOrVideo");
  ...
  return (
    <div className="quiz-container">
      <h1>IMAGES OR VIDEOS TAKEN OUT OF CONTEXT</h1>
...
export default ImageOrVideoScreen;
